<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ativacao_cliente.aspx.cs" Inherits="BetInGoal.ativacao_cliente" %>
...
<body>
    ...
    <br />
    <br />
      <button class="btn btn-primary" id="ativarAdmin">Ativar Cliente</button>
 </div>

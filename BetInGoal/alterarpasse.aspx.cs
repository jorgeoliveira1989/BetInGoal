...
namespace BetInGoal
{
    public partial class alterarpasse : System.Web.UI.Page
    {
        ...
        protected void btnAlterarPasse_Click(object sender, EventArgs e)
        {
            ...
            mycomm.Parameters.AddWithValue("@user", Session["utilizador"]);

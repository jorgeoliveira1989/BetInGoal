...
<form id="form1" runat="server">
  <nav class="navbar navbar-expand-xl navbar-dark custom-menu">
    <div class="container-fluid custom-content">
        <a class="nav-link" href="backoffice.aspx"><h1 class="navbar-brand">BACKOFFICE</h1></a>
        <p class="m-0">Hora do Servidor: <strong id="serverTime"></strong></p>
        <p class="m-0 mr-5">Utilizador:
            <asp:Label ID="lbl_utilizador" runat="server" CssClass="text-warning" /></p>
            ...
            <li class="nav-item">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="suporteDropdown">
                        ...
                        <a class="dropdown-item" href="responder.aspx">Responder</a>
                        <a class="dropdown-item" href="alterarestado.aspx">Alterar estado</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item mr-5">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="upgradeDropdown">
                        ...
                        <a class="dropdown-item" href="aceitarupgrades.aspx">Aceitar Upgrade</a>
                   </div>
                </div>
            </li>
            <li class="nav-item mr-3 ml-5">
                <!-- Adicionei a classe mr-3 para adicionar margem direita -->
                <asp:Button ID="btn_sair" class="btn btn-danger custom-logout" runat="server" Text="SAIR" />
            </li>
        </ul>
    </div>
</nav>

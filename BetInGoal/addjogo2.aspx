<%@ Page Title="" Language="C#" MasterPageFile="~/menu_admin.Master" AutoEventWireup="true" CodeBehind="addjogo2.aspx.cs" Inherits="BetInGoal.addjogo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="p-4 border rounded" style="max-width: 540px; width: 100%;">
            ...
            <h1>Jogos Para Prognósticos</h1>
                <br />
                Liga:
                <asp:TextBox ID="txt_nome_liga" runat="server" Width="302px"></asp:TextBox>
            &nbsp; Jornada:
            <asp:TextBox ID="txt_jornada" runat="server" TextMode="Number" min="1" max="50" Width="53px"></asp:TextBox>
            <br />
                <br />
